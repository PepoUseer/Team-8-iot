...
#define TEMPERATURE_UPDATE_SERVICE_INTERVAL (1 * 60 * 1000)
#define TEMPERATURE_UPDATE_NORMAL_INTERVAL  (3 * 60 * 1000)

#define HUMIDITY_TAG_UPDATE_SERVICE_INTERVAL (1 * 60 * 1000)
#define HUMIDITY_TAG_UPDATE_NORMAL_INTERVAL  (3 * 60 * 1000)

#define BAROMETER_TAG_UPDATE_SERVICE_INTERVAL (1 * 60 * 1000)
#define BAROMETER_TAG_UPDATE_NORMAL_INTERVAL  (3 * 60 * 1000)

#define CO2_UPDATE_SERVICE_INTERVAL (1 * 60 * 1000)
#define CO2_UPDATE_NORMAL_INTERVAL  (3 * 60 * 1000)
...
event_param_t temperature_event_param = { .channel = 0 };

// Humidity tag instance
twr_tag_humidity_t humidity;
event_param_t humidity_event_param = { .channel = 0 };

// Barometer tag instance
twr_tag_barometer_t barometer;
event_param_t barometer_event_param = { .channel = 0 };

// CO2
event_param_t co2_event_param = { .channel = 0 };
